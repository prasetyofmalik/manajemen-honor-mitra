...
<style>
    /* Styling consistency with Mitra Index view */
    .table thead th {
        font-size: 0.7rem;
    ...
    /* Enhanced specificity to override Bootstrap defaults */
    .table tbody tr.table-danger-light {
        background-color: #fff5f5 !important;
        /* Light Red */
    }

    /* Ensure the cells inside the warning row also inherit the color */
    .table tbody tr.table-danger-light td {
        background-color: inherit !important;
        border-bottom: 1px solid #fecaca !important;
        /* Slightly darker red border */
    }

    /* Keep the hover effect but make it a bit darker for the warning rows */
    .table-hover tbody tr.table-danger-light:hover {
        background-color: #fee2e2 !important;
    }

    /* Make sure the text inside warning rows is readable */
    .table-danger-light .text-danger {
    ...
    /* Custom badge for Dashboard context */
    .badge {
        border-radius: 4px;
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        noResultsRow.innerHTML = `<td colspan="100" class="text-center py-5 text-muted"><i class="bi bi-person-x d-block fs-4 mb-2"></i>Nama tidak ditemukan</td>`;
